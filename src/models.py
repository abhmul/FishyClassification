...
def inception_model(input_shape=(256, 256, 3), fcn=True, test=False, learning_rate=0.0001, dim_ordering='default'):
    ...
    global_pool = interm_shape[:2] if dim_ordering == 'tf' else interm_shape[1:]
