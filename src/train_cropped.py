...
def slide_window(X, window_size, xstride=1, ystride=1):
...
def window_gen(X, sliding_window_ratio=.25, window_min_ratio=.0625):
...
def batch_generator(X, y, batch_size, shuffle, img_size):
